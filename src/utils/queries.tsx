...
import {CreateSnippet, PaginatedSnippets, SnippetWithErr, Snippet, UpdateSnippet} from './snippet.ts';
...
export const useUpdateSnippetById = ({onSuccess}: { onSuccess: () => void }): UseMutationResult<SnippetWithErr, Error, {
    id: string;
